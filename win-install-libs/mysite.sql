...
INSERT INTO `django_flatpage` VALUES (1,'/about/','Татуаж в Киеве - о мастере','_С точки зрения потребителя этой услуги перманентный макияж – это возможность выглядеть хорошо при любых обстоятельствах, с минимальной затратой усилий и времени.\r\nПроцедура \"Перманентный макияж\" – это замечательный способ изменить цвет и форму бровей, век и губ надолго. Слово \"Permanent\" переводится как стойкий.	\r\nС медицинской точки зрения перманентный макияж – это введение красящего вещества (пигмента) в кожу на глубину 0,3 – 0,8мм, то есть на уровень сосочковой (папиллярной) дермы._',0,'',0);
...
INSERT INTO `django_flatpage_sites` VALUES (25,1,2);
...
-- Dump completed on 2014-09-05 23:36:04
